            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        {!! Form::open(['class' => 'user','route'=>'cart_category.store' , 'method' => 'post'])!!}
                        <div class="col-sm-8 mb-3 ">
                            <label for="title">Posts title</label>

                            {!! Form::text('category_name', null, array('required'=>'required', 'placeholder'=>'category title','class'=> 'form-control'))!!}
                        </div>
